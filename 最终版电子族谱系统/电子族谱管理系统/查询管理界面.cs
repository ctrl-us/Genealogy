...
namespace 电子族谱管理系统
{
    public partial class 查询管理界面 : Form
    {
        ...
        private void search_Click(object sender, EventArgs e)
        {
            ...
            String str2 = "SELECT Member_ID,Father_ID,Genealogy_ID,name,sex,birth,death,birthplace,address,spouse_name,spouse_state,number,num  FROM [Member] WHERE Member_ID='" + str1 + "'";
            ...
            if (d1 != null && d1.Rows.Count > 0)
            {
                ...
                textBox1.Text = d1.Rows[0]["num"].ToString();
            }
            else
            {
